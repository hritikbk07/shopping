            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
                {
                    ...
                    <img src="asa" alt="Product Image" className='w-full h-40 object-cover rounded-md md-4 border'/>
                    ...
                    <div className='flex flex-col sm:flex-row justify-between mt-4'>
                        <Link to={'/admin/editproduct'} className='flex items-center gap-2 text-blue-500 hover:text-blue-700 '>
                        <FaEdit/>Edit
                        </Link>
