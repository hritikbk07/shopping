  ...
  return (
    <section className='bg-gradient-to-r from-green-100 to-white px-6 py-12 md:flex items-center justify-between max-w-7xl mx-auto rounded-xl mt-10 m-8'>
      <div className='md:w-1/2 space-y-4'>
        ...
        <p className='text-gray-800'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Maxime, doloribus?</p>
        <button className='mt-4 bg-green-500 hover:bg-green-700 font-semibold px-6 py-3 rounded-lg'>Shop Now</button>
      </div>
